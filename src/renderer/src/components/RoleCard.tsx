...
export const RoleCard: React.FC<RoleCardProps> = ({ icon, title, description, iconStyle }) => {
	return (
		<Card className="h-full flex flex-col items-center justify-center cursor-pointer p-7 transition-all hover:-translate-y-1 hover:border-zinc-300 hover:shadow-xl">
			<div
				className={cn(
